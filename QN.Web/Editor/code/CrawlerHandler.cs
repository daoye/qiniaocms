...
public class Crawler
{
    ...
    public Crawler Fetch()
    {
        ...
        using (var response = request.GetResponse() as HttpWebResponse)
        {
            ...
            string fileName = Path.GetFileName(this.SourceUrl);
            string mimetype = response.ContentType;

            ServerUrl = PathFormatter.Format(fileName, Config.GetString("catcherPathFormat"));
            ...
            try
            {
                ...
                media media = fileService.Upload(bytes, fileName, mimetype);
