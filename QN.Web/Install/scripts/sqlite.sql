...
INSERT INTO "carte" ("id", "name", "siteid", "action", "controller", "area", "parent", "order", "icon", "allowactions", "activeflag") VALUES ('5', '添加相册', '0', 'add', 'albums', 'admin', '4', '1', NULL, 'Operate,Delete,Update,UpdatePost,PostList,PostListItem,OperatePost,DeletePost', 'albumadd');
INSERT INTO "carte" ("id", "name", "siteid", "action", "controller", "area", "parent", "order", "icon", "allowactions", "activeflag") VALUES ('6', '所有相册', '0', 'list', 'albums', 'admin', '4', '2', NULL, 'Operate,Delete,Update,UpdatePost,PostList,PostListItem,OperatePost,DeletePost', 'albumlist');
